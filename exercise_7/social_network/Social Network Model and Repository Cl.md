...
class UserAccountRepository
  ...
  def find(id)
    ...
    #return object where the id matches id
  end
  def create(user_account)
    #'INPUT INTO user_accounts SET ('email', 'username') VALUES ('johndoe@gmail.com', 'johndoe');'
...
user_account.length # =>  2

user_account[0].id # =>  1
user_account[0].email # =>  'johndoe@gmail.com '
user_account[0].username # =>  'johndoe'

# 2
# Find user based on id
repo = UserAccountsRepository.new
result = repo.find('1')
result.first.email => 'johndoe@gmail.com'
...
#all_users should contain the new UserAccount object
